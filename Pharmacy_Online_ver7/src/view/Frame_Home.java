...
public class Frame_Home extends JFrame {
	...
	public static Panel_LichSuDatHang panel_LichSuDatHang = new Panel_LichSuDatHang();
...
//		panel_ViThanhToan = new Panel_ViThanhToan();
		...
		panel_3.addMouseListener(new PanelButtonMouseAdapter(panel_3) {
			...
			@Override
			public void mouseClicked(MouseEvent e) {
				menuClicked(panel_LichSuDatHang);
			}
		});
		...
		panel_MainContent.add(panel_LichSuDatHang).setVisible(false);
	...
	public static void menuClicked(JPanel panel) {
		...
		panel_LichSuDatHang.setVisible(false);
